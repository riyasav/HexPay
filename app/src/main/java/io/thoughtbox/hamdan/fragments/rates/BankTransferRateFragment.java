...
import io.thoughtbox.hamdan.databinding.FragmentBankTransferRateBinding;
...
public class BankTransferRateFragment extends Fragment implements CurrencyRatesListener {
    FragmentBankTransferRateBinding binding;
    HomeViewModel viewModel;
    private NotificationAlerts alerts;
    public Dialog progressDialog;
    ArrayList<RateResponseData> rateDetails;
    ArrayList<RateResponseData> bankRateDetails;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_bank_transfer_rate, container, false);
...
//        binding.fcCode.setText(Universal.getInstance().getLoginResponsedata().getNationalitycurrencycode());
        ...
        rateData.observe(getViewLifecycleOwner(), rateResponseData -> {
            ...
            bankRateDetails = new ArrayList<>();
            cashPickupRateDetails = new ArrayList<>();
            for (int i = 0; i < rateResponseData.size(); i++) {
                if (rateResponseData.get(i).getTxntype().toUpperCase().equals("BANK TRANSFER")) {
                    ...
                    bankRateDetails.add(rateResponseData.get(i));
                }
            }
...
//        currencyCode=Universal.getInstance().getLoginResponsedata().getNationalitycurrencycode();
        viewModel.getUserRate();

    }

    public void onFcClicked(View view) {
        currencyBottomView(bankRateDetails);
    }
