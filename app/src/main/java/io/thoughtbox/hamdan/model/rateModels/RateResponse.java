...
public class RateResponse {
    ...
    @Expose
    private List<RateResponseData> responsedata = null;
    ...
    public List<RateResponseData> getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(List<RateResponseData> responsedata) {
