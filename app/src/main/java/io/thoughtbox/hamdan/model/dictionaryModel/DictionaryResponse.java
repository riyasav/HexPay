...
public class DictionaryResponse {
    ...
    @Expose
    private List<DictionaryResponseData> responsedata = null;
    ...
    public List<DictionaryResponseData> getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(List<DictionaryResponseData> responsedata) {
