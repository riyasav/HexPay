...
public class CashPickUpResponse {
    ...
    @Expose
    private List<CashPickUpResponseData> responsedata = null;
    ...
    public List<CashPickUpResponseData> getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(List<CashPickUpResponseData> responsedata) {
