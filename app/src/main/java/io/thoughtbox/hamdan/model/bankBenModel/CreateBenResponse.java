...
public class CreateBenResponse {
    ...
    @Expose
    private CreateBenResponseData responsedata;
    ...
    public CreateBenResponseData getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(CreateBenResponseData responsedata) {
