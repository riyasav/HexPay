...
public class ConfirmPaymentResponse {
    ...
    @Expose
    private ConfirmPaymentResponseData responsedata;
    ...
    public ConfirmPaymentResponseData getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(ConfirmPaymentResponseData responsedata) {
