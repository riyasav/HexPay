...
public class DashboardRateModel {
    ...
    @Expose
    private DashboardRateData responsedata;
    ...
    public DashboardRateData getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(DashboardRateData responsedata) {
