...
public class NotificationResponseModel {
    ...
    @Expose
    private List<NotificationResponseData> responsedata = null;
    ...
    public List<NotificationResponseData> getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(List<NotificationResponseData> responsedata) {
