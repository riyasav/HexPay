package io.thoughtbox.hamdan.model.benCreate;
...
public class CreateBeneficiaryResponse {
    ...
    @Expose
    private BenCreate responsedata;
    ...
    public BenCreate getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(BenCreate responsedata) {
