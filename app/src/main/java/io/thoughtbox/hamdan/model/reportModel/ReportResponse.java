...
public class ReportResponse {
    ...
    @Expose
    private List<ReportResponseData> responsedata = null;
    ...
    public List<ReportResponseData> getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(List<ReportResponseData> responsedata) {
