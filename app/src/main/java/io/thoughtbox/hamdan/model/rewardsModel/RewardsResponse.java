...
public class RewardsResponse {
    ...
    @Expose
    private List<RewardsResponseData> responsedata = null;
    ...
    public List<RewardsResponseData> getResponsedata() {
        return responsedata;
    }

    public void setResponsedata(List<RewardsResponseData> responsedata) {
